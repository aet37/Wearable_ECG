...
static void main_AlgHRandLeads(void);
...
static void main_AlgHRandLeads(void)
{
  ...
  /* Initialize function 'AlgHRandLeads' input arguments. */
  /* Initialize function input argument 'ECG_data'. */
  /* Call the entry-point 'AlgHRandLeads'. */
  argInit_1x3600_real_T(dv);
  AlgHRandLeads(dv, &heartRate, &leadsFlipped);
}
