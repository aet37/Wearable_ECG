###########################################################################
## Makefile generated for component 'addAB'. 
## 
## Makefile     : addAB_rtw.mk
## Generated on : Wed Mar 02 13:46:30 2022
## Final product: ./addAB.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/addAB -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
SRCS = $(START_DIR)/codegen/lib/addAB/addAB_data.c $(START_DIR)/codegen/lib/addAB/addAB_initialize.c $(START_DIR)/codegen/lib/addAB/addAB_terminate.c $(START_DIR)/codegen/lib/addAB/addAB.c
...
OBJS = addAB_data.o addAB_initialize.o addAB_terminate.o addAB.o
...
%.o : $(START_DIR)/codegen/lib/addAB/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/addAB/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
addAB_data.o : $(START_DIR)/codegen/lib/addAB/addAB_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


addAB_initialize.o : $(START_DIR)/codegen/lib/addAB/addAB_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


addAB_terminate.o : $(START_DIR)/codegen/lib/addAB/addAB_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


addAB.o : $(START_DIR)/codegen/lib/addAB/addAB.c
	$(CC) $(CFLAGS) -o "$@" "$<"
